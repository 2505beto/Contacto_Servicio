...
<div class="container">
 ...
 <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form method="post" action="/registrar-personal" class="row g-3">
                @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                    <label class="form-label col-form-label col-form-label-lg">Costo Laboral</label>
                    <input class ="form-control" type="number" name="costoPorHora" @if($errors->first('costoPorHora')) style="border: 1px solid red" @endif/>
                    @if($errors->first('costoPorHora'))
                    <span style="color: red">{{$errors->first('costoPorHora')}}</span>
                    @endif
                    <br>
                    </div>
                    <div class="col-md-4">
                    <label class="form-label col-form-label col-form-label-lg">Ocupacion</label>
                    <select class="form-control" name="id_servicio" @if($errors->first('id_servicio')) style="border: 1px solid red" @endif>
                    ...
                    <span style="color: red">{{$errors->first('id_servicio')}}</span>
                    @endif
                    </div>
                    <div class="col-12">
